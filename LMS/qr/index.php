       ...
       <div class="container">
            <div class="row">
                <div class="col-md-4" style="padding:10px;background:#fff;border-radius: 5px;" id="divvideo">
					<center><button class="login-box-msg"> <i class="glyphicon glyphicon-camera"></i> TAP HERE</button></center>
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($conn->connect_error){
                           ...
                           while ($row = mysqli_fetch_assoc($query)&&mysqli_fetch_assoc($result=FALSE)){
                        ?>
                            <tr>
