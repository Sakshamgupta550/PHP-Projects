<?php 
   ...
   $sql = "INSERT INTO books(book_id,bookTitle,author,publisherName,categories,ISBN,callNumber)
                    values ('$id','$title','$author', '$publisher','$category','$label','$call')";
      ...
      <div class="container">
         <form class="form-horizontal" role="form" enctype="multipart/form-data" action="addbook.php" method="post">
          <div class="form-group">
               <label for="Title" class="col-sm-2 control-label">BOOK ID</label>
               <div class="col-sm-10">
                  <input type="text" class="form-control" name="id" placeholder="book id" id="password" required>
               </div>
            </div>
            <div class="form-group">
